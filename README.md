# Hacker News Feed - a workflow for Alfred

This simple workflow pulls the submissions from the current Hacker News homepage and displays them in [Alfred](http://www.alfredapp.com/) (via keyword "hn") for quick and easy viewing.
